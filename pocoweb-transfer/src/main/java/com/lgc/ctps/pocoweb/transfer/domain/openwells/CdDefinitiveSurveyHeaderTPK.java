...
/**
 * The primary key class for the CD_DEFINITIVE_SURVEY_HEADER_T database table.
 *
 */
@Embeddable
@Data
public class CdDefinitiveSurveyHeaderTPK implements Serializable {
	...
	@Column(name="DEF_SURVEY_HEADER_ID", unique=true, nullable=false, length=5)
