...
/**
 * The primary key class for the CD_TEMP_GRADIENT_GROUP_T database table.
 *
 */
@Embeddable
@Data
public class CdTempGradientGroupTPK implements Serializable {
	...
	@Column(name="TEMP_GRADIENT_GROUP_ID", unique=true, nullable=false, length=5)
