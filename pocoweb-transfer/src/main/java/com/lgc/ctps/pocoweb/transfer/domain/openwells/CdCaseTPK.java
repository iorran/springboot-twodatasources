...
/**
 * The primary key class for the CD_CASE_T database table.
 *
 */
@Embeddable
@Data
public class CdCaseTPK implements Serializable {
	...
	@Column(name="CASE_ID", unique=true, nullable=false, length=5)
