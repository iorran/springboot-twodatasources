...
/**
 * The primary key class for the CD_SCENARIO_FORMATION_LINK_T database table.
 *
 */
@Embeddable
@Data
public class CdScenarioFormationLinkTPK implements Serializable {
	...
	@Column(name="WELLBORE_FORMATION_ID", insertable=false, updatable=false, unique=true, nullable=false, length=5)
	private String wellboreFormationId;
}