...
/**
 * The primary key class for the CD_SURVEY_HEADER_T database table.
 *
 */
@Embeddable
@Data
public class CdSurveyHeaderTPK implements Serializable {
	...
	@Column(name="SURVEY_HEADER_ID", unique=true, nullable=false, length=5)
