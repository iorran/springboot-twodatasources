...
/**
 * The primary key class for the CD_WELLBORE_FORMATION_T database table.
 *
 */
@Embeddable
@Data
public class CdWellboreFormationTPK implements Serializable {
	...
	@Column(name="WELLBORE_FORMATION_ID", unique=true, nullable=false, length=5)
