...
/**
 * The persistent class for the CD_FRAC_GRADIENT_GROUP_T database table.
 *
 */
@Entity
@Table(name="CD_FRAC_GRADIENT_GROUP_T")
@NamedQuery(name="CdFracGradientGroupT.findAll", query="SELECT c FROM CdFracGradientGroupT c")
@Getter
@Setter
public class CdFracGradientGroupT implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private CdFracGradientGroupTPK id;
...
//	private CdWellboreT cdWellboreT;
	...
	//bi-directional many-to-one association to CdFracGradientT
//	@OneToMany(mappedBy="cdFracGradientGroupT")
//	private List<CdFracGradientT> cdFracGradientTs;
}