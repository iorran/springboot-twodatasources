...
/**
 * The primary key class for the CD_FRAC_GRADIENT_GROUP_T database table.
 *
 */
@Embeddable
@Data
public class CdFracGradientGroupTPK implements Serializable {
	...
	@Column(name="FRAC_GRADIENT_GROUP_ID", unique=true, nullable=false, length=5)
