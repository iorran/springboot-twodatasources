...
/**
 * The primary key class for the CD_PORE_PRESSURE_GROUP_T database table.
 *
 */
@Embeddable
@Data
public class CdPorePressureGroupTPK implements Serializable {
	...
	@Column(name="PORE_PRESSURE_GROUP_ID", unique=true, nullable=false, length=5)
