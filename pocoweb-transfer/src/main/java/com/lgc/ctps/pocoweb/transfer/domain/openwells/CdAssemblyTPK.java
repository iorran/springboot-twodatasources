...
/**
 * The primary key class for the CD_ASSEMBLY_T database table.
 *
 */
@Embeddable
@Data
public class CdAssemblyTPK implements Serializable {
	...
	@Column(name="ASSEMBLY_ID", unique=true, nullable=false, length=5)
